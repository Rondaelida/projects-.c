...
- Оформи решение как статическую библиотеку с названием *s_string.a* (с заголовочным файлом s_string.h);
...
- Предусмотри Makefile для сборки библиотеки и тестов (с целями all, clean, test, s_string.a, gcov_report);
...
- Функция должна быть размещена в библиотеке s_string.h;
...
- Функции должны быть размещены в библиотеке s_string.h;
